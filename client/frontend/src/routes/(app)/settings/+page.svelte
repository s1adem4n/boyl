...
<div class="flex flex-col gap-4 p-4">
	...
	<div class="flex flex-col gap-2">
		<p class="text-muted text-sm">Where should your games be saved?</p>
	...
	<div class="flex flex-col gap-2">
		<p class="text-muted text-sm">Customise your client appearance.</p>
		<label class="flex gap-1">
			<Checkbox
				bind:checked={() => clientState.settings.fitCovers,
				(value) => clientState.setSetting('fitCovers', value)}
			/>
			Fit covers
		</label>
	</div>
